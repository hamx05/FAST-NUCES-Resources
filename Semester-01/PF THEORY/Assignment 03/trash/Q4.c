...
struct joining_date { // Ye nested hoga worker me
        int year;
        int month;
        int date;
        int hour;
...
struct bonus_date { // Ye nested hoga bonus me
        int year;
        int month;
        int date;
} b_d;
...
struct affected_from { // ye nested hoga title me
    int year;
    int month;
    int date;
    int hour;
...
void main(void) {
    ...
    for (i = 0; i < n; i++) {
        ...
        fflush(stdin);
        gets(worker[i].first_name);
        printf("Enter the last name: ");
        fflush(stdin);
        gets(worker[i].last_name);
