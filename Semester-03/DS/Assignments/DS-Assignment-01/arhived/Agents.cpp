...
#include "Tickets.cpp"
#include "TicketResolutionLogs.cpp"
#include "ReportingAndAnalytics.cpp"
using namespace std;
...
class AgentsList {
    ...
    public:
        ...
        // void printAgents() {
        //     if (size == 0) {
        //         cout<<"No Agents added in the database." << endl;
        //         return;
        //     }
        //     cout<<"_____________ Current Agents: " << size << " _____________" << endl;
        //     for (int i = 0; i < size; i++) {
        //         cout << "Agent ID: " << agents[i].getAgentID() << endl;
        //         cout << "Name: " << agents[i].getAgentName() << endl;
        //         cout << "Status: " << agents[i].getStatus() << endl;
        //         cout << "Tickets Assigned: " << agents[i].getAssignedTicketCount() << endl << endl;
        //     }
        // }
