...
// Everything done, bas round off wali condition lagani hai parameterized constructor aur setter me
class RollerCoaster {
    string name;
    int height;
    int length;
    ...
    public:
        ...
        RollerCoaster (string name, int height, int length, float speed, int capacity) { // Round off wagera wali conditions lagani hain
            this->name = name;
            this->height = height;
            this->length = length;
        ...
        // Setter functions
        void setProperties (string name, int height, int length, float speed, int capacity, int currentNumRiders) { // Round off wagera wali conditions lagani hain
            this->name = name;
            this->height = height;
            this->length = length;
            this->capacity = capacity;
