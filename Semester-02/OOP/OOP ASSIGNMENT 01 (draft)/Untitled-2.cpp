...
//     for (i=0; i<N; i++) {
//         cout<<"test";
//         if (tableArray[tableIndex].getOccSeats() == 0 && tableArray[tableIndex].isClean()==true && tableArray[tableIndex].getTotalSeats() >= sizeOfFriendsGroup) {
//             cout<<"You have been assigned table number " << i+1 << "! The table has a capacity to fit " << tableArray[tableIndex].getTotalSeats() << "people." << endl;
